...
<form action="/campaign" method="POST" class="max-w-2xl mx-auto bg-white p-8 shadow-md rounded-lg space-y-6">
    ...
    <div class="space-y-2 bg-gray-50 p-4 rounded-lg">
        {{-- text-sm dihapus, pakai text-lg aja --}}
        <h2 class="text-lg font-bold text-blue-600 uppercase tracking-wider">Info Rekening Pencairan (1:1)</h2>
    ...
    <div class="space-y-2">
        {{-- text-sm dihapus, pakai text-lg aja --}}
        <h2 class="text-lg font-bold text-emerald-600 uppercase tracking-wider">Pilih Kategori (M:M)</h2>
